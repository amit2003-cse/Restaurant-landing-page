  ...
  return (
    <section className="section section--alt" id="about">
      <div className="section__container fade-in">
        ...
        <h2>About Super Restaurant</h2>
        <p className="about__text">
          Super Restaurant is dedicated to serving freshly prepared dishes with authentic taste
        ...
        <p className="about__text">
          ...
          Super Restaurant ensures a satisfying dining experience.
        </p>
      </div>
    </section>
  );
